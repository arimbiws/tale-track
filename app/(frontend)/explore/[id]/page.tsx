        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 shadow-sm border border-gray-100 flex flex-col md:flex-row gap-8 md:gap-12">
          <div className="w-full md:w-1/3 shrink-0">
            <div className="aspect-[2/3] rounded-2xl overflow-hidden shadow-xl border border-gray-100 relative">
              {book.cover_url ? <img src={book.cover_url} alt={book.title} className="w-full h-full object-cover" /> : <div className="w-full h-full bg-gray-200 flex items-center justify-center text-primary">No Cover</div>}
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <div className="bg-primary/20 px-4 py-3 rounded-xl border border-gray-100 flex items-center gap-3">
                <div className="bg-white p-2 rounded-lg shadow-sm">
                  <BookOpen className="w-5 h-5 text-primary" />
                </div>
                <div>
                  <p className="text-xs text-primary font-bold uppercase tracking-wider">Halaman</p>
              ...
              <div className="bg-primary/20 px-4 py-3 rounded-xl border border-gray-100 flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-primary font-bold uppercase tracking-wider">Tahun</p>
            ...
            <div className="mb-8">
              ...
              <div className="text-text leading-relaxed text-sm sm:text-base prose prose-sm max-w-none" dangerouslySetInnerHTML={{ __html: book.description }} />
            </div>

            {book.categories.length > 0 && (
              <div className="mt-auto pt-6 border-t border-primary/20">
                <p className="text-xs font-bold text-primary uppercase tracking-wider mb-3">Kategori</p>
