  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-28 pt-32 md:pt-40 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-20">
        <a href="mailto:hello@taletrack.com" className="group bg-white p-8 rounded-4xl border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 text-center flex flex-col items-center">
        ...
        <a
          ...
          className="group bg-white p-8 rounded-4xl border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 text-center flex flex-col items-center"
        >
      ...
      <div className="bg-linear-to-br from-primary/5 to-accent/10 rounded-[3rem] p-8 md:p-12 border border-primary/10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
