...
export default function ContactPage() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-28 pt-34 md:pt-38">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div>
          <h1 className="font-heading text-5xl md:text-6xl font-bold text-text mb-6 leading-tight">
            Let's Connect <br /> & Share.
          </h1>
          <p className="text-gray-500 text-base mb-10 leading-relaxed max-w-md">Have book recommendations, questions, or just want to say hi? Our team is always happy to hear from you.</p>

          <div className="space-y-8">
            <div className="flex items-start gap-5 group">
              <div className="w-14 h-14 bg-white shadow-sm rounded-2xl flex items-center justify-center text-xl shrink-0 group-hover:bg-primary group-hover:text-white transition-colors duration-300">
              ...
              <div>
                ...
                <p className="text-gray-500 mt-1 leading-relaxed">Jl. Sunset Road No. 88, Kuta, Bali, Indonesia 80361</p>
              </div>
            </div>
